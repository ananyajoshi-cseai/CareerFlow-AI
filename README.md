...
<p align="center">
  ...
  <br>
  <i> Leverages <b>Google Gemini 1.5 Flash</b> to generate tailored cover letters and tough, gap-specific interview questions.</i>
</p>

## ✨ Core Features

* **🔍 AI Skill-Gap Scanner**: Deep analysis of Resumes vs. JDs to extract missing technical and soft skills with actionable feedback And Plotting it visually.
